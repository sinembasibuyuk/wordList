...
class MainWindow(QWidget):
    ...
    def setup_styles(self):
        ...
        QPushButton {
            background-color:#3ac99c;
            font-size:50px;}
        """)

        self.button_next.setStyleSheet("""
        QPushButton {
            background-color:#e3d340;
            font-size:50px;}
        """)
    ...
    def set_application_style(self):
        palette = QPalette()
        palette.setColor(QPalette.ColorRole.Window,QColor(157, 226, 235))
        palette.setColor(QPalette.ColorRole.WindowText,QColor(56, 7, 4))
